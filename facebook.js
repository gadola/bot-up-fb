...
function Facebook(accessToken, groupId)
{
    ...
    this.postNews = async(images) => {
        ...
        formPublish.append('message',
            ...
            '* Đây là post tự động được tạo bởi efert và lấy dữ liệu từ VnExpress qua RSS các bạn có thể check source code [tại đây](https://github.com/gadola/bot-up-fb.git)');
